...
---
```{r echo=FALSE}
knitr::opts_chunk$set(eval=T,message=F,warning=F,fig.align = 'center')
```
...
# Missing values  
+  **Data inspection**(Section \@ref(inspection))中提到,`Fare`有1个缺失值，`Embarked`有2个缺失值，`Age`有263个缺失值，在建模前需要对缺失值进行补齐
